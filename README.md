# OSPSuite.SimModel.Schema
XSD Schema definition for xml model created for the OSPSuite.SimModel calculation engine 
...
## License
SPSuite.SimModel.Schema is released under the [GPLv2 License](LICENSE).
